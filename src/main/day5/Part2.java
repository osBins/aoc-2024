...
public class Part2 {
    ...
    public static void main(String[] args) throws IOException {
        List<String> input = InputReader.readInputFile("test/day5.txt");
        ...
        for (Map.Entry<Integer, List<Set<Integer>>> entry : beforeAfterMap.entrySet()) {
            int index = beforeAfterMap.get(entry.getKey()).get(0).size();
            positions.put(entry.getKey(), index);
        }

        System.out.println(positions);

//        System.out.println(beforeAfterMap);
    }
}
